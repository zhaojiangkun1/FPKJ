...
public class PuPiao {
     ...
     */
    @Test(groups = {"开具普票"}, description = "所有参数均正常，开具一张增值税普通发票",priority = 13)
    ...
    @Test(groups = {"普票冲红"}, description = "所有参数均正常，冲红一张增值税普通发票",priority = 14)
    ...
    @Test(groups = {"开具普票"},description = "开具一张带折扣行的普票",priority = 15)
    ...
    @Test(groups = {"开具普票"}, description = "所有参数均正常，开具一张6行商品的普票",priority = 17)
    ...
    @Test(groups = {"开票普票"}, description = "所有参数均正常,开具一张8行商品的普票",priority = 18)
    ...
    @Test(groups = {"开具普票"}, description = "所有参数均正常，开具一张10行商品的普票",priority = 19)
    ...
    @Test(groups = {"普票冲红"}, description = "冲红一张带清单普票",priority = 20)
